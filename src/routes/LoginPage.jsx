...
const LoginPage = () => {
  return (
    <>
      <style>{`
        /* Common styles for all social OAuth buttons */
        .cl-socialButtonsIconButton {
          background-color: #2c3e50 !important; /* dark bluish-gray */
          color: white !important;
          border-radius: 12px !important;
          border: 1px solid #2563EB !important; /* electric blue border */
          padding: 8px 14px !important;
          display: flex !important;
          align-items: center !important;
          gap: 10px !important;
          box-shadow: 0 0 8px rgba(37, 99, 235, 0.5) !important; /* subtle electric glow */
        ...
        .cl-socialButtonsIconButton:hover {
          background-color: #2563EB !important; /* electric blue on hover */
      ...
      <div className="flex items-center justify-center h-[calc(100vh-80px)] bg-[#0F1117]">
        <SignIn appearance={{ baseTheme: devscoopTheme }} signUpUrl="/register"/>
      </div>
    </>
  );
};
